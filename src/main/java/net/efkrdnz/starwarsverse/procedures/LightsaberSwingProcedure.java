	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("starwarsverse:lightsaber_swing")), SoundSource.NEUTRAL, (float) 0.4, 1);
			} else {
				_level.playLocalSound(entity.getX(), entity.getY(), entity.getZ(), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("starwarsverse:lightsaber_swing")), SoundSource.NEUTRAL, (float) 0.4, 1, false);
			}
		}
	}
