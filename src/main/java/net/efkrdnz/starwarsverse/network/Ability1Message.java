...
import net.efkrdnz.starwarsverse.procedures.Ability1OnKeyPressedProcedure;
...
public record Ability1Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability1Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(StarwarsverseMod.MODID, "key_ability_1"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		StarwarsverseMod.addNetworkMessage(Ability1Message.TYPE, Ability1Message.STREAM_CODEC, Ability1Message::handleData);
	}
}
