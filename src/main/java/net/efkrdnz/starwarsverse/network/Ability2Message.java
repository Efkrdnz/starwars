...
import net.efkrdnz.starwarsverse.procedures.Ability2OnKeyPressedProcedure;
...
public record Ability2Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability2Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(StarwarsverseMod.MODID, "key_ability_2"));
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Ability2OnKeyPressedProcedure.execute(world, entity);
		}
		if (type == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		StarwarsverseMod.addNetworkMessage(Ability2Message.TYPE, Ability2Message.STREAM_CODEC, Ability2Message::handleData);
	}
}
